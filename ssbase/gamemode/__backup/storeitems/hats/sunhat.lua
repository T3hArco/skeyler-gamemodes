...
ITEM.Model = "models/captainbigbutt/skeyler/hats/sunhat.mdl"		-- Model used by the item
...
ITEM.Models = {} 
ITEM.Models[SS.STORE.MODEL.DANTE] = {{0, 0, 0, pos=Vector(2.3, -1.5, 0), ang=Angle(0, -90, -85), scale=0.925}}
ITEM.Models[SS.STORE.MODEL.ELIN] = {{0, 0, 0, pos=Vector(3.0, -4.5, 0), ang=Angle(0, -90, -90), scale=1.1}}
ITEM.Models[SS.STORE.MODEL.MIKU] = {{0, 0, 0, pos=Vector(4.5, -4, 0.1), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models[SS.STORE.MODEL.TRON] = {{0, 0, 0, pos=Vector(4.206, -2.46, 0), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models[SS.STORE.MODEL.USIF] = {{0, 0, 0, pos=Vector(1.25, -2.5, 0.2), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models[SS.STORE.MODEL.ZERO] = {
	{0, 0, 0, pos=Vector(3.6, -2.7, 0), ang=Angle(0, -90, -90), scale=1.01},
	{0, 0, 1, pos=Vector(9.6, -2.7, 0), ang=Angle(0, -90, -90), scale=1.01}
}
/* ************* */