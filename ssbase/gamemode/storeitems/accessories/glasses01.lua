...
ITEM.Models = {} 
ITEM.Models["elin"] = {pos=Vector(2.0, 1.7, 0), ang=Angle(72, 0, -90), scale=1.025} 
ITEM.Models["miku"] = {pos=Vector(2.3, 0.075, 0), ang=Angle(90, 0, -90), scale=1} 
ITEM.Models["tron"] = {pos=Vector(3.5, 2.5, 0), ang=Angle(85, 0, -90), scale=1.05} 
ITEM.Models["usif"] = {pos=Vector(1.6, 2.1, 0), ang=Angle(90, 0, -90), scale=1} 
ITEM.Models["zer0"] = {pos=Vector(3.5, 1.9, 0), ang=Angle(85, 0, -90), scale=0.9} 