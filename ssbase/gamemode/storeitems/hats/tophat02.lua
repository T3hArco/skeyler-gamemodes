...
ITEM.Model = "models/captainbigbutt/skeyler/hats/tophat02.mdl"	-- Model used by the item
...
ITEM.Models = {} 
ITEM.Models[SS.STORE.MODEL.DANTE] = {{0, 0, 0, pos=Vector(8.5, 2.35, -1), ang=Angle(0, -90, -90), scale=0.9}}
ITEM.Models[SS.STORE.MODEL.ELIN] = {{0, 0, 0, pos=Vector(9.25, 1.25, -1.25), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models[SS.STORE.MODEL.MIKU] = {{0, 0, 0, pos=Vector(9.5, 0.9, -1.175), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models[SS.STORE.MODEL.TRON] = {{0, 0, 0, pos=Vector(9.6, 1.25, -1.5), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models[SS.STORE.MODEL.USIF] = {{0, 0, 0, pos=Vector(6.75, 2.3, -0.75), ang=Angle(-4, -90, -90), scale=1}}
ITEM.Models[SS.STORE.MODEL.ZERO] = {
	{0, 0, 0, pos=Vector(8.1, 1, -1), ang=Angle(-4, -90, -90), scale=0.9},
	{0, 0, 1, pos=Vector(14.1, 1, -1), ang=Angle(-4, -90, -90), scale=0.9}
}
/* ************* */