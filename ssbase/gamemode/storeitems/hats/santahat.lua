...
ITEM.Models = {} 
ITEM.Models["dante"] = {	["0_0_0_0"]= {pos=Vector(4.5, 0.25, 0), ang=Angle(0, -90, -90), scale=0.7}}
ITEM.Models["elin"] = {	["0_0_0_0"]= {pos=Vector(4.5, -1.6, 0), ang=Angle(0, -90, -90), scale=1.05}}
ITEM.Models["miku"] = {	["0_0_0_0"]= {pos=Vector(4.5, -1, 0), ang=Angle(0, -90, -90), scale=0.95}}
ITEM.Models["tron"] = {	["0_0_0_0"]= {pos=Vector(5, 0.25, 0), ang=Angle(0, -90, -90), scale=0.9}}
ITEM.Models["usif"] = {	["0_0_0_0"]= {pos=Vector(3, 0.5, 0.2), ang=Angle(0, -90, -90), scale=0.8}}
ITEM.Models["zer0"] = {
	["0_0_0_0"]= {pos=Vector(4.75, -0.1, 0), ang=Angle(0, -90, -90), scale=0.75},
	["0_1_0_0"]= {pos=Vector(9.75, -0.1, 0), ang=Angle(0, -90, -90), scale=0.75}
}
/* ************* */