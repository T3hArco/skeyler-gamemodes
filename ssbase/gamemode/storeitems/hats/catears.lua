...
ITEM.Models = {} 
ITEM.Models["elin"] = {	["0_0_0_0"]= {pos=Vector(-1, 1, 0), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models["miku"] = {	["0_0_0_0"]= {pos=Vector(0, 1, 0), ang=Angle(0, -90, -90), scale=0.95}}
ITEM.Models["tron"] = {	["0_0_0_0"]= {pos=Vector(0.25, 1.5, 0), ang=Angle(0, -90, -90), scale=0.925}}
ITEM.Models["usif"] = {	["0_0_0_0"]= {pos=Vector(-1.5, 1.5, 0.2), ang=Angle(0, -90, -90), scale=0.9}}
ITEM.Models["zer0"] = {
	["0_0_0_0"]= {pos=Vector(1, 1, 0), ang=Angle(0, -90, -90), scale=0.8},
	["0_1_0_0"]= {pos=Vector(6, 1, 0), ang=Angle(0, -90, -90), scale=0.8}
}
/* ************* */