...
ITEM.Models = {} 
ITEM.Models["dante"] = {	["0_0_0_0"]= {pos=Vector(5.5, 0.4, 0), ang=Angle(0, -90, -90), scale=0.875}}
ITEM.Models["elin"] = {	["0_0_0_0"]= {pos=Vector(6.5, 0, 0), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models["miku"] = {	["0_0_0_0"]= {pos=Vector(6.75, -0.2, 0), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models["tron"] = {	["0_0_0_0"]= {pos=Vector(6.75, 0.5, 0), ang=Angle(0, -90, -90), scale=0.98}}
ITEM.Models["usif"] = {	["0_0_0_0"]= {pos=Vector(4.5, 0.5, 0.2), ang=Angle(0, -90, -90), scale=0.925}}
ITEM.Models["zer0"] = {
	["0_0_0_0"]= {pos=Vector(5.5, 0, 0), ang=Angle(0, -90, -90), scale=0.825},
