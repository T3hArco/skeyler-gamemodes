...
ITEM.Models = {} 
ITEM.Models[SS.STORE.MODEL.DANTE] = {{0, 0, 0, pos=Vector(0.25, -0.4, 0), ang=Angle(8, -90, -90), scale=1.025}}
ITEM.Models[SS.STORE.MODEL.ELIN] = {{0, 0, 0, pos=Vector(0, -0.75, 0), ang=Angle(8, -90, -90), scale=1.15}}
ITEM.Models[SS.STORE.MODEL.MIKU] = {{0, 0, 0, pos=Vector(0, -1.75, 0), ang=Angle(8, -90, -90), scale=1.125}}
ITEM.Models[SS.STORE.MODEL.TRON] = {{0, 0, 0, pos=Vector(1, -0.8, 0), ang=Angle(5, -90, -90), scale=1.175}}
ITEM.Models[SS.STORE.MODEL.USIF] = {{0, 0, 0, pos=Vector(-0.875, 0.85, 0.2), ang=Angle(5, -90, -90), scale=1.025}}
ITEM.Models[SS.STORE.MODEL.ZERO] = {
	{0, 0, 0, pos=Vector(0, -1, 0), ang=Angle(5, -90, -90), scale=1.1},
	{0, 0, 1, pos=Vector(6, -1, 0), ang=Angle(5, -90, -90), scale=1.1}
}
/* ************* */