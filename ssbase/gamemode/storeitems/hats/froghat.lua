...
ITEM.Models = {} 
ITEM.Models["dante"] = {	["0_0_0_0"]= {pos=Vector(5, 0.35, 0), ang=Angle(0, -90, -90), scale=0.735}}
ITEM.Models["elin"] = {	["0_0_0_0"]= {pos=Vector(5, -0.9, 0), ang=Angle(0, -90, -90), scale=0.87}}
ITEM.Models["miku"] = {	["0_0_0_0"]= {pos=Vector(5.25, -1.1, 0), ang=Angle(0, -90, -90), scale=0.88}}
ITEM.Models["tron"] = {	["0_0_0_0"]= {pos=Vector(6, 0.15, 0), ang=Angle(0, -90, -90), scale=0.85}}
ITEM.Models["usif"] = {	["0_0_0_0"]= {pos=Vector(3.5, 0.6, 0.2), ang=Angle(0, -90, -90), scale=0.79}}
ITEM.Models["zer0"] = {
	["0_0_0_0"]= {pos=Vector(5, -0.9, 0), ang=Angle(0, -90, -90), scale=0.85},
