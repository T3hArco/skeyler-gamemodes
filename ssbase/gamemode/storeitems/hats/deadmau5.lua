...
ITEM.Models = {} 
ITEM.Models["dante"] = {	["0_0_0_0"]= {pos=Vector(3.5, 0, 0), ang=Angle(0, -90, -90), scale=0.95}}
ITEM.Models["elin"] = {	["0_0_0_0"]= {pos=Vector(3.5, 0.5, 0), ang=Angle(0, -90, -90), scale=0.975}}
ITEM.Models["miku"] = {	["0_0_0_0"]= {pos=Vector(3, 0.75, 0), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models["tron"] = {	["0_0_0_0"]= {pos=Vector(4.25, 0.7, 0), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models["usif"] = {	["0_0_0_0"]= {pos=Vector(2.75, 1.0, 0.2), ang=Angle(0, -90, -90), scale=1}}
ITEM.Models["zer0"] = {
	["0_0_0_0"]= {pos=Vector(3.25, 0.5, 0), ang=Angle(0, -90, -90), scale=0.93},
	["0_1_0_0"]= {pos=Vector(9.25, 0.5, 0), ang=Angle(0, -90, -90), scale=0.93}
}
/* ************* */