ITEM.ID = "dante"							--Should be a unique string that identifies the item
ITEM.Name = "Dante"						--The name the item should display
 
ITEM.Price = 200000
 
ITEM.Model = "models/captainbigbutt/skeyler/playermodels/dante.mdl"			--Model used by the item
