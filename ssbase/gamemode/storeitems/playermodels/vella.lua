ITEM.ID = "vella"							--Should be a unique string that identifies the item
ITEM.Name = "Vella"						--The name the item should display
 
ITEM.Price = 200000
 
ITEM.Model = "models/captainbigbutt/skeyler/playermodels/vella.mdl"			--Model used by the item
